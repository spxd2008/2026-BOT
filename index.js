const {
  ...
  console.log('▶ ●───ᴅᴛᴢ ɴᴏᴠᴀ xᴍᴅ────▶ ● connected to whatsapp ✅')
  ...
  ╟─────────────────╢
  ║ ♻ 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐋𝐈𝐍𝐊          
  ║ https://wa.link/pg19c7                
  ╠═════════════════╣
  ║      ▶ ●───ᴅᴛᴢ ɴᴏᴠᴀ xᴍᴅ────▶ ●               
  ║ > © ᴘᴏᴡᴇʀᴇᴅ ʙʏ ▶ ●───ᴅᴛᴢ ɴᴏᴠᴀ xᴍᴅ────▶ ●       
  ╚═════════════════╝
`;
  conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://files.catbox.moe/fpyw9m.png` }, caption: up })
...
if (!isReact && senderNumber === botNumber) {
  ...
  app.get("/", (req, res) => {
  res.send("hey, ▶ ●───ᴅᴛᴢ ɴᴏᴠᴀ xᴍᴅ────▶ ● started✅");
  });
